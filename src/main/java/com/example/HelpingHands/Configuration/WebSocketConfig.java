...
/**
 * STOMP over WebSocket (SockJS fallback) configuration for the chat feature.
 * - Clients connect to /ws and authenticate via JWT on the STOMP CONNECT frame
 *   (see JwtChannelInterceptor).
 * - Messages sent to /app/** are routed to @MessageMapping handlers.
 * - The broker relays messages to /topic/** (broadcast)
